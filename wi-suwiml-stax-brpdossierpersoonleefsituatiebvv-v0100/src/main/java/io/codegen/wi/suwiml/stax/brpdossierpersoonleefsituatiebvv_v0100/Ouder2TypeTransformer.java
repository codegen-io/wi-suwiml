...
import io.codegen.wi.suwiml.proto.brpdossierpersoonleefsituatiebvv_v0100.Ouder2Type;
...
final class Ouder2TypeTransformer {
  public static Ouder2Type read(XMLStreamReader reader) throws XMLStreamException {
    QName parent = reader.getName();
    Ouder2Type.Builder builder = Ouder2Type.newBuilder();
  ...
  public static void write(XMLStreamWriter writer, Ouder2Type value) throws XMLStreamException {
